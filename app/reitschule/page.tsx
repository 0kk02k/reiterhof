            ...
            {courses.map((course, i) => (
              ...
              >
                ...
                <motion.a
                  ...
                  className="block text-center w-full py-4 bg-[#bf9e32] text-sand-100 font-bold rounded-lg hover:bg-[#aa8c2c] active:bg-[#947a27] transition-colors uppercase tracking-widest text-sm shadow-md"
                >
